 ...
 */
class WorkerOrderStatus extends \AppBundle\Entity\WorkerOrderStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\WorkerOrderStatus' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\WorkerOrderStatus' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\WorkerOrderStatus' . "\0" . 'sequence', '' . "\0" . 'AppBundle\\Entity\\WorkerOrderStatus' . "\0" . 'orders'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WorkerOrderStatus $proxy) {
