 ...
 */
class PaymentMethod extends \AppBundle\Entity\PaymentMethod implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PaymentMethod' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\PaymentMethod' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\PaymentMethod' . "\0" . 'repairs', '' . "\0" . 'AppBundle\\Entity\\PaymentMethod' . "\0" . 'sequence'];
        }
