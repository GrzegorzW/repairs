...
',
  ...
  array (
    'test' => 'alias do testu',
    'emailLeaveOpinionSubject' => 'Zaproszenie do wyrażenia opinii.',
    'emailRepairSubject' => 'Wiadomość dotycząca naprawy.',
    'emailBeginSubject' => 'Potwierdzenie rozpoczęcia naprawy.',
    'flashLeaveOpinionInvitation' => 'Wiadomość e-mail zachęcająca do wyrażenia opinii została wysłana.',
    'flashChangesConfirmation' => 'Zmiany zostały wprowadzone.',
    'flashMessageAdded' => 'Wiadomość została dodana.',
    'flashEmailSended' => 'Wiadomość e-mail została wysłana.',
    'flashUserAdded' => 'Dodawanie użytkownika zakończone powodzeniem.',
    'flashCantFindUser' => 'Nie znaleziono użytkownika, któremu chcesz przypisać naprawę.',
    'flashRepairAdded' => 'Naprawa została dodana.',
    'flashRegistrationConfirmation' => 'Wiadomość porwierdzająca rejestrację naprawy została wysłana.',
    'flashTelChanged' => 'Numer telefonu został zmieniony.',
    'flashPasswordReset' => 'Hasło zostało zresetowane.',
    'flashRepairerAdded' => 'Nowy pracownik został dodany.',
    'flashUsernameOrEmailIsOccupied' => 'Użytkownik o tym loginie lub adresie e-mail już istnieje.',
    'flashPermissionDenied' => 'Brak uprawnień do wyświetlenia.',
    'flashNoRepair' => 'Brak naprawy.',
    'flashNoOpinionPossibility' => 'Brak możliwości dodania opinii.',
    'flashOpinionAdded' => 'Twoja opinia została dodana.',
    'flashEmailOccupied' => 'Podany adres e-mail jest już zajęty.',
    'flashNoRepairId' => 'Nie ma naprawy id =',
    'flashNoParagraph' => 'Nie ma takiego punktu regulaminu.',
    'flashNoUser' => 'Nie ma użytkownika id =',
    'flashPermissionsRemoved' => 'Uprawnienia zostały usunięte.',
    'flashEmailAlreadyTaken' => 'Użytkownik o takim adresie e-mail już istnieje. Wprowadź użytkownika z bazy danych.',
    'flashDatabaseTransactionError' => 'Podczas zapisu wystąpił błąd - zmiany nie zostały wprowadzone.',
    'emailWaitingForAcceptation' => 'Prośba o akceptację wyceny.',
    'emailReparation' => 'Sprzęt w trakcie naprawy.',
    'emailResignation' => 'Rezygnacja z naprawy.',
    'emailReady' => 'Sprzęt gotowy do odbioru.',
    'emailWaitingForDiagnosis' => 'Sprzęt oczekuje na diagnozę.',
    'flashLocalizationAdded' => 'Oddział został dodany.',
    'flashParagraphAdded' => 'Punkt regulaminu został dodany.',
    'flashParagraphDeleted' => 'Punkt regulaminu został usunięty.',
    'flashEntryAdded' => 'Wpis został dodany.',
    'flashEntryEdited' => 'Wpis został zmieniony.',
    'flashRepairerEdited' => 'Dane pracownika zostały zmienione.',
    'flashLocalizationEdited' => 'Dane lokalizacji zostały zmienione.',
    'flashEmployeeFired' => 'Pracownik został zwolniony.',
    'flashSaleAdded' => 'Dodano do sprzedanych.',
    'flashSaleKindAdded' => 'Dodano typ sprzedaży.',
    'emailNewRepairer' => 'Witamy w zespole.',
    'emailWorkerAssignation' => 'Przypisanie naprawy.',
    'flashSaleCostDeleted' => 'Usunięto koszt sprzedaży.',
    'current_repairer' => 'Naprawiający',
    'current_status' => 'Status',
    'create' => 'Utworzono',
    'update' => 'Zmieniono',
    'delete' => 'Usunięto',
    'description' => 'Opis',
    'priceAmount' => 'Wartość [w gr]',
    'priceCurrency' => 'Waluta',
    'cost_kind' => 'Typ',
    'name' => 'Nazwa',
    'totalPriceAmount' => 'Ogólna wycena [gr]',
    'sale_kind' => 'Typ',
    'totalPriceCurrency' => 'Waluta',
    'flashRepairCostDeleted' => 'Usunięto koszt serwisu.',
    'emailDiagnosing' => 'Sprzęt w trakcie diagnozowania.',
    'localization' => 'Lokalizacja',
    'flashUserDataChanged' => 'Dane klienta zostały zmienione',
    'flashClientSideUserDataChanged' => 'Twoje dane zostały zmienione',
    'acceptation.method.application' => 'poprzez aplikację',
    'acceptation.method.email' => 'emailowo',
    'acceptation.method.phone' => 'telefonicznie',
    'acceptation.method.personally' => 'osobiście',
    'emailRepairPricingAccepted' => 'Potwierdzenie akceptacji wyceny.',
    'payment_method' => 'Metoda płatności',
    'html.text' => 'Pole tekstowe',
    'html.checkbox' => 'Pole wielokrotnego wyboru',
    'html.radio' => 'Pole jednokrotnego wyboru',
    'form.label.delete' => 'Usuń',
    'company.name' => 'Nazwa firmy',
    'company.street' => 'Ulica',
    'company.city' => 'Miasto',
    'company.post_code' => 'Kod pocztowy',
    'company.nip' => 'NIP',
    'company.main_site' => 'Adres firmowej strony WWW',
    'company.mailing_subject_begin' => 'Mailing - początek tematu, np.: [nazwa firmy]',
    'company.small_logo' => 'Miniaturka',
    'company.logo' => 'Logotyp',
    'ROLE_PERMISSION_PUBLIC_MESSAGES' => 'Wysyłanie wiadomości do klienta',
    'ROLE_PERMISSION_POKWITOWANIE_CREATE' => 'Dodawanie naprawy',
    'ROLE_PERMISSION_SALE_CREATE' => 'Dodawanie do sprzedanych',
    'ROLE_PERMISSION_USER_SECTION' => 'Dostęp do szczegółowych danych klienta',
    'ROLE_PERMISSION_CHANGE_REPAIRER' => 'Zmiany naprawiającego',
    'ROLE_PERMISSION_LOCALIZATION_REPAIRS' => 'Wyświetlanie napraw z własnej lokalizacji',
    'ROLE_PERMISSION_LOCALIZATION_DEVICES' => 'Wyświetlanie urządzeń z własnej lokalizacji',
    'ROLE_PERMISSION_ALL_REPAIRS' => 'Wyświetlanie wszystkich napraw',
    'ROLE_PERMISSION_ALL_DEVICES' => 'Wyświetlanie wszystkich urządzeń',
  ),
));
