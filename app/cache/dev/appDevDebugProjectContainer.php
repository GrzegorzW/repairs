...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'changelog_manager' => 'getChangelogManagerService',
            'communication_manager' => 'getCommunicationManagerService',
            'company_manager' => 'getCompanyManagerService',
            'config_cache_factory' => 'getConfigCacheFactoryService',
            'controller_name_converter' => 'getControllerNameConverterService',
            'custom_field_template_manager' => 'getCustomFieldTemplateManagerService',
            ...
            'device_manager' => 'getDeviceManagerService',
            ...
            'email_manager' => 'getEmailManagerService',
            'file_locator' => 'getFileLocatorService',
            'filesystem' => 'getFilesystemService',
            'financial_manager' => 'getFinancialManagerService',
            ...
            'limit_pagination_listener' => 'getLimitPaginationListenerService',
            'locale_listener' => 'getLocaleListenerService',
            'localization_manager' => 'getLocalizationManagerService',
            'logger' => 'getLoggerService',
            'login_success_listener' => 'getLoginSuccessListenerService',
            ...
            'pagination_manager' => 'getPaginationManagerService',
            'password_resetting' => 'getPasswordResettingService',
            'pokwitowanie_history_manager' => 'getPokwitowanieHistoryManagerService',
            'profiler' => 'getProfilerService',
            'profiler_listener' => 'getProfilerListenerService',
            'property_accessor' => 'getPropertyAccessorService',
            'regulations_manager' => 'getRegulationsManagerService',
            'repair_manager' => 'getRepairManagerService',
            ...
            'status_manager' => 'getStatusManagerService',
            ...
            'tbbc_money.form_type.currency' => 'getTbbcMoney_FormType_CurrencyService',
            'tbbc_money.form_type.money' => 'getTbbcMoney_FormType_MoneyService',
            'tbbc_money.form_type.simple_money' => 'getTbbcMoney_FormType_SimpleMoneyService',
            ...
            'total_repair_pricing_subscriber' => 'getTotalRepairPricingSubscriberService',
            ...
            'worker_order_manager' => 'getWorkerOrderManagerService',
        );
        $this->aliases = array(
    ...
    /**
     * Gets the 'changelog_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\ChangelogManager A AppBundle\Service\ChangelogManager instance.
     */
    protected function getChangelogManagerService()
    {
        return $this->services['changelog_manager'] = new \AppBundle\Service\ChangelogManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'communication_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CommunicationManager A AppBundle\Service\CommunicationManager instance.
     */
    protected function getCommunicationManagerService()
    {
        return $this->services['communication_manager'] = new \AppBundle\Service\CommunicationManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'company_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CompanyManager A AppBundle\Service\CompanyManager instance.
     */
    protected function getCompanyManagerService()
    {
        return $this->services['company_manager'] = new \AppBundle\Service\CompanyManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    /**
     * Gets the 'custom_field_template_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\CustomFieldTemplateManager A AppBundle\Service\CustomFieldTemplateManager instance.
     */
    protected function getCustomFieldTemplateManagerService()
    {
        return $this->services['custom_field_template_manager'] = new \AppBundle\Service\CustomFieldTemplateManager($this->get('doctrine.orm.default_entity_manager'), $this->get('validator'));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.request', array(0 => 'limit_pagination_listener', 1 => 'onKernelRequest'), 0);
        ...
        $instance->addSubscriberService('password_resetting', 'AppBundle\\EventListener\\FOSListener');
    ...
    /**
     * Gets the 'device_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\DeviceManager A AppBundle\Service\DeviceManager instance.
     */
    protected function getDeviceManagerService()
    {
        return $this->services['device_manager'] = new \AppBundle\Service\DeviceManager($this->get('doctrine.orm.default_entity_manager'), $this->get('validator'), $this->get('custom_field_template_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('company_logo', $e, $a, $b));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('company_small_logo', $e, $a, $b));
        $g->addEventSubscriber($this->get('total_repair_pricing_subscriber'));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('company_logo', $e, $a, $b));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('company_logo', $e, $a, $b));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('company_logo', $e, $a, $b));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('company_small_logo', $e, $a, $b));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('company_small_logo', $e, $a, $b));
        $g->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\InjectListener('company_small_logo', $e, $a, $b));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'serwis', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $d, $g, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Translatable/Entity'), 1 => ($this->targetDirs[3].'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Loggable/Entity'), 2 => ($this->targetDirs[3].'/vendor/gedmo/doctrine-extensions/lib/Gedmo/Tree/Entity'), 3 => ($this->targetDirs[3].'/src/AppBundle/Entity')));

        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/vendor/tbbc/money-bundle/Tbbc/MoneyBundle/Resources/config/doctrine') => 'Tbbc\\MoneyBundle\\Entity'));
        ...
        $d->addDriver($c, 'Tbbc\\MoneyBundle\\Entity');
        ...
        $e->setEntityNamespaces(array('Gedmo' => 'Gedmo\\Tree\\Entity', 'TbbcMoneyBundle' => 'Tbbc\\MoneyBundle\\Entity', 'AppBundle' => 'AppBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_3d3c3436add68b5d5c95f0936340f9e355f6f49633b8f15805ece91b9fe67057');
    ...
    /**
     * Gets the 'email_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\EmailManager A AppBundle\Service\EmailManager instance.
     */
    protected function getEmailManagerService()
    {
        return $this->services['email_manager'] = new \AppBundle\Service\EmailManager($this->get('swiftmailer.mailer.default'), 'pongosgw@gmail.com', $this->get('templating'), $this->get('doctrine.orm.default_entity_manager'), $this->get('translator'));
    }
    ...
    /**
     * Gets the 'financial_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\FinancialManager A AppBundle\Service\FinancialManager instance.
     */
    protected function getFinancialManagerService()
    {
        return $this->services['financial_manager'] = new \AppBundle\Service\FinancialManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getFosRest_FormatNegotiatorService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/api', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'json', 1 => 'xml', 2 => 'html'), 'fallback_format' => 'html', 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => array(), 'stop' => false));
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/', NULL, NULL, NULL, array()), array('priorities' => array(0 => 'html', 1 => 'css', 2 => 'js', 3 => '*/*'), 'fallback_format' => NULL, 'prefer_extension' => '2.0', 'methods' => NULL, 'attributes' => array(), 'stop' => false));
    ...
    public function getFosRest_SerializerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['fos_rest.serializer'] = FOSRestBundleSerializerJMSSerializerAdapter_000000002e990e7e000000007e1fba6aa6a83cf0af948980900b70d37eb17513::staticProxyConstructor(
    ...
    {
        return $this->services['fos_rest.serializer.exception_normalizer.jms'] = new \FOS\RestBundle\Serializer\Normalizer\ExceptionHandler(new \FOS\RestBundle\Util\ExceptionValueMap(array('Symfony\\Component\\Routing\\Exception\\ResourceNotFoundException' => true, 'Symfony\\Component\\HttpKernel\\Exception\\HttpException' => true, 'Symfony\\Component\\HttpKernel\\Exception\\AccessDeniedHttpException' => true, 'Symfony\\Component\\Security\\Core\\Exception\\AccessDeniedException' => true)), true);
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('twig'), array('template' => array('confirmation' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting' => 'FOSUserBundle:Resetting:email.txt.twig'), 'from_email' => array('confirmation' => array('webmaster@example.com' => 'webmaster'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
    ...
    /**
     * Gets the 'helpers' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Helpers\Helpers A AppBundle\Helpers\Helpers instance.
     */
    protected function getHelpersService()
    {
        return $this->services['helpers'] = new \AppBundle\Helpers\Helpers();
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[2].'/Resources/serializer/fos'), 'Knp\\Bundle\\PaginatorBundle' => ($this->targetDirs[2].'/Resources/serializer/KnpPaginatorBundle'), 'Misd\\PhoneNumberBundle' => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Tbbc\\MoneyBundle' => ($this->targetDirs[3].'/vendor/tbbc/money-bundle/Tbbc/MoneyBundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer'), 'Stof\\DoctrineExtensionsBundle' => ($this->targetDirs[3].'/vendor/stof/doctrine-extensions-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\MigrationsBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-migrations-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineCacheBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-cache-bundle/Resources/config/serializer'), 'Vich\\UploaderBundle' => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'ApiBundle' => ($this->targetDirs[3].'/src/ApiBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer'), 'Knp\\Component\\Pager' => ($this->targetDirs[2].'/Resources/serializer/KnpPager')));
    ...
    /**
     * Gets the 'limit_pagination_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\LimitPaginationListener A AppBundle\EventListener\LimitPaginationListener instance.
     */
    protected function getLimitPaginationListenerService()
    {
        return $this->services['limit_pagination_listener'] = new \AppBundle\EventListener\LimitPaginationListener($this->get('request_stack'));
    }
    ...
    /**
     * Gets the 'localization_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\LocalizationManager A AppBundle\Service\LocalizationManager instance.
     */
    protected function getLocalizationManagerService()
    {
        return $this->services['localization_manager'] = new \AppBundle\Service\LocalizationManager($this->get('doctrine.orm.default_entity_manager'), $this->get('libphonenumber.phone_number_util'));
    }
    ...
    /**
     * Gets the 'login_success_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\LoginSuccessListener A AppBundle\EventListener\LoginSuccessListener instance.
     */
    protected function getLoginSuccessListenerService()
    {
        return $this->services['login_success_listener'] = new \AppBundle\EventListener\LoginSuccessListener($this->get('router'), $this->get('security.authorization_checker'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\NotificationManager A AppBundle\Service\NotificationManager instance.
     */
    protected function getNotificationManagerService()
    {
        return $this->services['notification_manager'] = new \AppBundle\Service\NotificationManager($this->get('doctrine.orm.default_entity_manager'), $this->get('user_manager'), $this->get('security.authorization_checker'));
    }

    /**
     * Gets the 'pagination_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\PaginationManager A AppBundle\Service\PaginationManager instance.
     */
    protected function getPaginationManagerService()
    {
        return $this->services['pagination_manager'] = new \AppBundle\Service\PaginationManager($this->get('knp_paginator'), $this->get('request_stack'));
    }

    /**
     * Gets the 'password_resetting' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\FOSListener A AppBundle\EventListener\FOSListener instance.
     */
    protected function getPasswordResettingService()
    {
        return $this->services['password_resetting'] = new \AppBundle\EventListener\FOSListener($this->get('router'), $this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'pokwitowanie_history_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\PokwitowanieHistoryManager A AppBundle\Service\PokwitowanieHistoryManager instance.
     */
    protected function getPokwitowanieHistoryManagerService()
    {
        return $this->services['pokwitowanie_history_manager'] = new \AppBundle\Service\PokwitowanieHistoryManager($this->get('doctrine.orm.default_entity_manager'), $this->get('regulations_manager'), $this->get('router'), $this->get('device_manager'));
    }
    ...
    /**
     * Gets the 'regulations_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\RegulationsManager A AppBundle\Service\RegulationsManager instance.
     */
    protected function getRegulationsManagerService()
    {
        return $this->services['regulations_manager'] = new \AppBundle\Service\RegulationsManager($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'repair_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\RepairManager A AppBundle\Service\RepairManager instance.
     */
    protected function getRepairManagerService()
    {
        return $this->services['repair_manager'] = new \AppBundle\Service\RepairManager($this->get('doctrine.orm.default_entity_manager'), $this->get('session'), $this->get('helpers'), $this->get('security.authorization_checker'));
    }
    ...
    protected function getRouting_LoaderService()
    {
        ...
        $f->addLoader(new \FOS\RestBundle\Routing\Loader\RestYamlCollectionLoader($b, $d, true, array('json' => false, 'html' => true), 'json'));
        $f->addLoader(new \FOS\RestBundle\Routing\Loader\RestXmlCollectionLoader($b, $d, true, array('json' => false, 'html' => true), 'json'));
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/pricing-accepted');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/worker/pokwitowanie');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/worker/user');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/worker/sale');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/worker');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/resetting');
        ...
        $q->add($i, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        $q->add($j, array(0 => 'ROLE_USER'), NULL);
        $q->add($k, array(0 => 'ROLE_PERMISSION_POKWITOWANIE_CREATE'), NULL);
        $q->add($l, array(0 => 'ROLE_PERMISSION_USER_SECTION'), NULL);
        $q->add($m, array(0 => 'ROLE_PERMISSION_SALE_CREATE'), NULL);
        $q->add($n, array(0 => 'ROLE_WORKER'), NULL);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($q, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c), 2 => $s, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $r, 'main', new \Symfony\Component\Security\Http\Authentication\CustomAuthenticationSuccessHandler($this->get('login_success_listener'), array('use_referer' => false, 'always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path'), 'main'), $t, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '56f444d2db4d32.36005350', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $q, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $r, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $r, '/login', false), NULL, NULL, $a, false));
    }
    ...
    /**
     * Gets the 'status_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\StatusManager A AppBundle\Service\StatusManager instance.
     */
    protected function getStatusManagerService()
    {
        return $this->services['status_manager'] = new \AppBundle\Service\StatusManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('pongosgw@gmail.com');
        $a->setPassword('G03WaWit');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin(array(0 => 'pongosgw@gmail.com'), array());
    }

    /**
     * Gets the 'tbbc_money.form_type.currency' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tbbc\MoneyBundle\Form\Type\CurrencyType A Tbbc\MoneyBundle\Form\Type\CurrencyType instance.
     */
    protected function getTbbcMoney_FormType_CurrencyService()
    {
        return $this->services['tbbc_money.form_type.currency'] = new \Tbbc\MoneyBundle\Form\Type\CurrencyType(array(0 => 'PLN', 1 => 'EUR'), 'PLN');
    }

    /**
     * Gets the 'tbbc_money.form_type.money' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tbbc\MoneyBundle\Form\Type\MoneyType A Tbbc\MoneyBundle\Form\Type\MoneyType instance.
     */
    protected function getTbbcMoney_FormType_MoneyService()
    {
        return $this->services['tbbc_money.form_type.money'] = new \Tbbc\MoneyBundle\Form\Type\MoneyType(2);
    }

    /**
     * Gets the 'tbbc_money.form_type.simple_money' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tbbc\MoneyBundle\Form\Type\SimpleMoneyType A Tbbc\MoneyBundle\Form\Type\SimpleMoneyType instance.
     */
    protected function getTbbcMoney_FormType_SimpleMoneyService()
    {
        return $this->services['tbbc_money.form_type.simple_money'] = new \Tbbc\MoneyBundle\Form\Type\SimpleMoneyType($this->get('tbbc_money.pair_manager'), 2);
    }

    /**
     * Gets the 'tbbc_money.formatter.money_formatter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tbbc\MoneyBundle\Formatter\MoneyFormatter A Tbbc\MoneyBundle\Formatter\MoneyFormatter instance.
     */
    protected function getTbbcMoney_Formatter_MoneyFormatterService()
    {
        return $this->services['tbbc_money.formatter.money_formatter'] = new \Tbbc\MoneyBundle\Formatter\MoneyFormatter(2);
    }

    /**
     * Gets the 'tbbc_money.money_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tbbc\MoneyBundle\Money\MoneyManager A Tbbc\MoneyBundle\Money\MoneyManager instance.
     */
    protected function getTbbcMoney_MoneyManagerService()
    {
        return $this->services['tbbc_money.money_manager'] = new \Tbbc\MoneyBundle\Money\MoneyManager('PLN', 2);
    }

    /**
     * Gets the 'tbbc_money.pair.csv_storage' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tbbc\MoneyBundle\Pair\Storage\CsvStorage A Tbbc\MoneyBundle\Pair\Storage\CsvStorage instance.
     */
    protected function getTbbcMoney_Pair_CsvStorageService()
    {
        return $this->services['tbbc_money.pair.csv_storage'] = new \Tbbc\MoneyBundle\Pair\Storage\CsvStorage(($this->targetDirs[2].'/data/tbbc_money/ratio_file_name.csv'), 'PLN');
    }

    /**
     * Gets the 'tbbc_money.pair_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tbbc\MoneyBundle\Pair\PairManager A Tbbc\MoneyBundle\Pair\PairManager instance.
     */
    protected function getTbbcMoney_PairManagerService()
    {
        $this->services['tbbc_money.pair_manager'] = $instance = new \Tbbc\MoneyBundle\Pair\PairManager($this->get('tbbc_money.pair.csv_storage'), array(0 => 'PLN', 1 => 'EUR'), 'PLN', $this->get('debug.event_dispatcher'));

        $instance->setRatioProvider($this->get('tbbc_money.ratio_provider.yahoo_finance'));

        return $instance;
    }

    /**
     * Gets the 'tbbc_money.ratio_provider.google' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tbbc\MoneyBundle\Pair\RatioProvider\GoogleRatioProvider A Tbbc\MoneyBundle\Pair\RatioProvider\GoogleRatioProvider instance.
     */
    protected function getTbbcMoney_RatioProvider_GoogleService()
    {
        return $this->services['tbbc_money.ratio_provider.google'] = new \Tbbc\MoneyBundle\Pair\RatioProvider\GoogleRatioProvider();
    }

    /**
     * Gets the 'tbbc_money.ratio_provider.yahoo_finance' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tbbc\MoneyBundle\Pair\RatioProvider\YahooFinanceRatioProvider A Tbbc\MoneyBundle\Pair\RatioProvider\YahooFinanceRatioProvider instance.
     */
    protected function getTbbcMoney_RatioProvider_YahooFinanceService()
    {
        return $this->services['tbbc_money.ratio_provider.yahoo_finance'] = new \Tbbc\MoneyBundle\Pair\RatioProvider\YahooFinanceRatioProvider();
    }

    /**
     * Gets the 'tbbc_money.twig.currency' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tbbc\MoneyBundle\Twig\Extension\CurrencyExtension A Tbbc\MoneyBundle\Twig\Extension\CurrencyExtension instance.
     */
    protected function getTbbcMoney_Twig_CurrencyService()
    {
        return $this->services['tbbc_money.twig.currency'] = new \Tbbc\MoneyBundle\Twig\Extension\CurrencyExtension($this->get('tbbc_money.formatter.money_formatter'));
    }

    /**
     * Gets the 'tbbc_money.twig.money' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Tbbc\MoneyBundle\Twig\Extension\MoneyExtension A Tbbc\MoneyBundle\Twig\Extension\MoneyExtension instance.
     */
    protected function getTbbcMoney_Twig_MoneyService()
    {
        return $this->services['tbbc_money.twig.money'] = new \Tbbc\MoneyBundle\Twig\Extension\MoneyExtension($this->get('tbbc_money.formatter.money_formatter'), $this->get('tbbc_money.pair_manager'));
    }
    ...
    /**
     * Gets the 'total_repair_pricing_subscriber' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventSubscriber\TotalRepairPricingSubscriber A AppBundle\EventSubscriber\TotalRepairPricingSubscriber instance.
     */
    protected function getTotalRepairPricingSubscriberService()
    {
        return $this->services['total_repair_pricing_subscriber'] = new \AppBundle\EventSubscriber\TotalRepairPricingSubscriber();
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.el.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.el.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.el.yml')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.et.yml')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sl.yml')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.zh_CN.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.zh_CN.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.zh_CN.yml')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sv.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sv.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sv.yml')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ja.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ja.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ja.yml')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.vi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.vi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.vi.yml')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hu.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hu.yml')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Latn.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sr_Latn.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sr_Latn.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.sr_Latn.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pl.yml'), 5 => ($this->targetDirs[2].'/Resources/FOSUserBundle/translations/FOSUserBundle.pl.yml'), 6 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.pl.xlf'), 7 => ($this->targetDirs[3].'/src/AppBundle/Resources/translations/messages.pl.xlf')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fr.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.fr.xlf'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.fr.yml'), 7 => ($this->targetDirs[3].'/src/ApiBundle/Resources/translations/messages.fr.xlf')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ca.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ca.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ca.yml')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt_BR.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt_BR.yml')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.uk.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.uk.yml')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.tr.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.tr.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.tr.yml')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.da.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.da.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.da.yml')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt.yml')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.th.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.th.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.th.yml')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.he.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.he.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.he.yml')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.bg.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.bg.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.bg.yml')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.id.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.id.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.id.yml')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.cs.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.cs.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.cs.yml')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ro.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ro.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ro.yml')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.de.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.de.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.de.xlf')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lb.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lb.yml')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.az.xlf')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.en.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.en.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en.xlf'), 6 => ($this->targetDirs[3].'/vendor/vich/uploader-bundle/Resources/translations/VichUploaderBundle.en.yml')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Cyrl.xlf')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sk.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sk.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sk.yml')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nl.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nl.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.nl.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hr.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hr.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hr.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.hr.xlf')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.no.xlf')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fi.yml')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fa.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fa.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fa.yml')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.es.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.es.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.es.xlf')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.gl.xlf')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lt.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lt.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lt.yml')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.it.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.it.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.it.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ar.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ar.yml')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eu.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eu.yml')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ru.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ru.yml'), 5 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.ru.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lv.yml'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lv.yml')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_PT.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ua.xlf')), 'nb' => array(0 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nb.yml'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nb.yml')), 'en_AU' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_AU.xlf')), 'en_CA' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_CA.xlf')), 'en_GB' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_GB.xlf')), 'en_PH' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_PH.xlf')), 'en_ZA' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_ZA.xlf')), 'en_SG' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_SG.xlf')), 'bs_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.bs_Cyrl.xlf')), 'en_IE' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_IE.xlf')), 'en_NZ' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_NZ.xlf')), 'bs' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.bs.xlf')), 'es_419' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.es_419.xlf')), 'sr' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.sr.xlf')), 'en_US' => array(0 => ($this->targetDirs[3].'/vendor/misd/phone-number-bundle/Resources/translations/validators.en_US.xlf')))), array());
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'TbbcMoneyBundle:Form:fields.html.twig', 2 => 'bootstrap_3_layout.html.twig', 3 => 'AppBundle:Form:fields.html.twig'), 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'filename', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'TbbcMoneyBundle:Form:fields.html.twig', 2 => 'bootstrap_3_layout.html.twig', 3 => 'MisdPhoneNumberBundle:Form:tel_bootstrap.html.twig', 4 => 'AppBundle:Form:fields.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'AppBundle', 1 => 'FOSUserBundle', 2 => 'TwigBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addExtension($this->get('tbbc_money.twig.money'));
        $instance->addExtension($this->get('tbbc_money.twig.currency'));
        ...
        $instance->addGlobal('company_service', $this->get('company_manager'));
        $instance->addGlobal('repair_service', $this->get('repair_manager'));
        $instance->addGlobal('communication_service', $this->get('communication_manager'));
        $instance->addGlobal('helper_service', $this->get('helpers'));
        $instance->addGlobal('localization_service', $this->get('localization_manager'));
        $instance->addGlobal('notification_service', $this->get('notification_manager'));
        $instance->addGlobal('device_manager', $this->get('device_manager'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/tbbc/money-bundle/Tbbc/MoneyBundle/Resources/views'), 'TbbcMoney');
    ...
    {
        return $this->services['user_manager'] = new \AppBundle\Service\UserManager($this->get('doctrine.orm.default_entity_manager'), $this->get('security.password_encoder'), array('ROLE_PERMISSION_PUBLIC_MESSAGES' => array(), 'ROLE_PERMISSION_POKWITOWANIE_CREATE' => array(), 'ROLE_PERMISSION_SALE_CREATE' => array(), 'ROLE_PERMISSION_USER_SECTION' => array(), 'ROLE_PERMISSION_CHANGE_REPAIRER' => array(), 'ROLE_PERMISSION_LOCALIZATION_REPAIRS' => array(), 'ROLE_PERMISSION_LOCALIZATION_DEVICES' => array(), 'ROLE_PERMISSION_ALL_REPAIRS' => array(), 'ROLE_PERMISSION_ALL_DEVICES' => array(), 'ROLE_USER' => array(), 'ROLE_WORKER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_WORKER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_PERMISSION_PUBLIC_MESSAGES', 2 => 'ROLE_PERMISSION_POKWITOWANIE_CREATE', 3 => 'ROLE_PERMISSION_SALE_CREATE', 4 => 'ROLE_PERMISSION_USER_SECTION', 5 => 'ROLE_PERMISSION_CHANGE_REPAIRER', 6 => 'ROLE_PERMISSION_LOCALIZATION_REPAIRS', 7 => 'ROLE_PERMISSION_LOCALIZATION_DEVICES', 8 => 'ROLE_PERMISSION_ALL_REPAIRS', 9 => 'ROLE_PERMISSION_ALL_DEVICES')), $this->get('security.authorization_checker'), $this->get('libphonenumber.phone_number_util'));
    }
    ...
    /**
     * Gets the 'worker_order_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\WorkerOrderManager A AppBundle\Service\WorkerOrderManager instance.
     */
    protected function getWorkerOrderManagerService()
    {
        return $this->services['worker_order_manager'] = new \AppBundle\Service\WorkerOrderManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        return $this->services['fos_rest.serializer.jms_handler_registry'] = new \JMS\Serializer\Handler\LazyHandlerRegistry($this, array(1 => array('libphonenumber\\PhoneNumber' => array('json' => array(0 => 'misd_phone_number.serializer.handler', 1 => 'serializePhoneNumber'), 'xml' => array(0 => 'misd_phone_number.serializer.handler', 1 => 'serializePhoneNumber'), 'yml' => array(0 => 'misd_phone_number.serializer.handler', 1 => 'serializePhoneNumber')), 'Exception' => array('json' => array(0 => 'fos_rest.serializer.exception_normalizer.jms', 1 => 'serializeToJson'), 'xml' => array(0 => 'fos_rest.serializer.exception_normalizer.jms', 1 => 'serializeToXml')), 'DateTime' => array('json' => array(0 => 'jms_serializer.datetime_handler', 1 => 'serializeDateTime'), 'xml' => array(0 => 'jms_serializer.datetime_handler', 1 => 'serializeDateTime'), 'yml' => array(0 => 'jms_serializer.datetime_handler', 1 => 'serializeDateTime')), 'DateInterval' => array('json' => array(0 => 'jms_serializer.datetime_handler', 1 => 'serializeDateInterval'), 'xml' => array(0 => 'jms_serializer.datetime_handler', 1 => 'serializeDateInterval'), 'yml' => array(0 => 'jms_serializer.datetime_handler', 1 => 'serializeDateInterval')), 'ArrayCollection' => array('json' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection'), 'xml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection'), 'yml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection')), 'Doctrine\\Common\\Collections\\ArrayCollection' => array('json' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection'), 'xml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection'), 'yml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection')), 'Doctrine\\ORM\\PersistentCollection' => array('json' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection'), 'xml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection'), 'yml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection')), 'Doctrine\\ODM\\MongoDB\\PersistentCollection' => array('json' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection'), 'xml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection'), 'yml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection')), 'Doctrine\\ODM\\PHPCR\\PersistentCollection' => array('json' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection'), 'xml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection'), 'yml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'serializeCollection')), 'PhpCollection\\Sequence' => array('json' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'serializeSequence'), 'xml' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'serializeSequence'), 'yml' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'serializeSequence')), 'PhpCollection\\Map' => array('json' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'serializeMap'), 'xml' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'serializeMap'), 'yml' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'serializeMap')), 'Symfony\\Component\\Form\\Form' => array('xml' => array(0 => 'jms_serializer.form_error_handler', 1 => 'serializeFormToxml'), 'json' => array(0 => 'jms_serializer.form_error_handler', 1 => 'serializeFormTojson'), 'yml' => array(0 => 'jms_serializer.form_error_handler', 1 => 'serializeFormToyml')), 'Symfony\\Component\\Form\\FormError' => array('xml' => array(0 => 'jms_serializer.form_error_handler', 1 => 'serializeFormErrorToxml'), 'json' => array(0 => 'jms_serializer.form_error_handler', 1 => 'serializeFormErrorTojson'), 'yml' => array(0 => 'jms_serializer.form_error_handler', 1 => 'serializeFormErrorToyml')), 'Symfony\\Component\\Validator\\ConstraintViolationList' => array('xml' => array(0 => 'jms_serializer.constraint_violation_handler', 1 => 'serializeListToxml'), 'json' => array(0 => 'jms_serializer.constraint_violation_handler', 1 => 'serializeListTojson'), 'yml' => array(0 => 'jms_serializer.constraint_violation_handler', 1 => 'serializeListToyml')), 'Symfony\\Component\\Validator\\ConstraintViolation' => array('xml' => array(0 => 'jms_serializer.constraint_violation_handler', 1 => 'serializeViolationToxml'), 'json' => array(0 => 'jms_serializer.constraint_violation_handler', 1 => 'serializeViolationTojson'), 'yml' => array(0 => 'jms_serializer.constraint_violation_handler', 1 => 'serializeViolationToyml'))), 2 => array('libphonenumber\\PhoneNumber' => array('json' => array(0 => 'misd_phone_number.serializer.handler', 1 => 'deserializePhoneNumberFromJson'), 'xml' => array(0 => 'misd_phone_number.serializer.handler', 1 => 'deserializePhoneNumberFromXml')), 'DateTime' => array('json' => array(0 => 'jms_serializer.datetime_handler', 1 => 'deserializeDateTimeFromjson'), 'xml' => array(0 => 'jms_serializer.datetime_handler', 1 => 'deserializeDateTimeFromxml'), 'yml' => array(0 => 'jms_serializer.datetime_handler', 1 => 'deserializeDateTimeFromyml')), 'ArrayCollection' => array('json' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection'), 'xml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection'), 'yml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection')), 'Doctrine\\Common\\Collections\\ArrayCollection' => array('json' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection'), 'xml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection'), 'yml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection')), 'Doctrine\\ORM\\PersistentCollection' => array('json' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection'), 'xml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection'), 'yml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection')), 'Doctrine\\ODM\\MongoDB\\PersistentCollection' => array('json' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection'), 'xml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection'), 'yml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection')), 'Doctrine\\ODM\\PHPCR\\PersistentCollection' => array('json' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection'), 'xml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection'), 'yml' => array(0 => 'jms_serializer.array_collection_handler', 1 => 'deserializeCollection')), 'PhpCollection\\Sequence' => array('json' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'deserializeSequence'), 'xml' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'deserializeSequence'), 'yml' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'deserializeSequence')), 'PhpCollection\\Map' => array('json' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'deserializeMap'), 'xml' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'deserializeMap'), 'yml' => array(0 => 'jms_serializer.php_collection_handler', 1 => 'deserializeMap')))));
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_PERMISSION_PUBLIC_MESSAGES' => array(), 'ROLE_PERMISSION_POKWITOWANIE_CREATE' => array(), 'ROLE_PERMISSION_SALE_CREATE' => array(), 'ROLE_PERMISSION_USER_SECTION' => array(), 'ROLE_PERMISSION_CHANGE_REPAIRER' => array(), 'ROLE_PERMISSION_LOCALIZATION_REPAIRS' => array(), 'ROLE_PERMISSION_LOCALIZATION_DEVICES' => array(), 'ROLE_PERMISSION_ALL_REPAIRS' => array(), 'ROLE_PERMISSION_ALL_DEVICES' => array(), 'ROLE_USER' => array(), 'ROLE_WORKER' => array(0 => 'ROLE_USER'), 'ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_WORKER'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_PERMISSION_PUBLIC_MESSAGES', 2 => 'ROLE_PERMISSION_POKWITOWANIE_CREATE', 3 => 'ROLE_PERMISSION_SALE_CREATE', 4 => 'ROLE_PERMISSION_USER_SECTION', 5 => 'ROLE_PERMISSION_CHANGE_REPAIRER', 6 => 'ROLE_PERMISSION_LOCALIZATION_REPAIRS', 7 => 'ROLE_PERMISSION_LOCALIZATION_DEVICES', 8 => 'ROLE_PERMISSION_ALL_REPAIRS', 9 => 'ROLE_PERMISSION_ALL_DEVICES')));
    }
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('company_small_logo' => array('namer' => 'vich_uploader.namer_uniqid', 'uri_prefix' => '/uploads/companies/logos', 'upload_destination' => ($this->targetDirs[2].'/../web/uploads/companies/logos'), 'delete_on_remove' => true, 'directory_namer' => NULL, 'inject_on_load' => true, 'delete_on_update' => true, 'db_driver' => 'orm'), 'company_logo' => array('namer' => 'vich_uploader.namer_uniqid', 'uri_prefix' => '/uploads/companies/logos', 'upload_destination' => ($this->targetDirs[2].'/../web/uploads/companies/logos'), 'delete_on_remove' => true, 'directory_namer' => NULL, 'inject_on_load' => true, 'delete_on_update' => true, 'db_driver' => 'orm')), '_name');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_port' => 3306,
            'database_name' => 'serwis',
            'database_user' => 'root',
            'database_password' => 'root',
            'mailer_transport' => 'gmail',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'pongosgw@gmail.com',
            'mailer_password' => 'G03WaWit',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'google_client_id' => NULL,
            'google_client_secret' => NULL,
            'google_redirect_url' => 'http://pokwitowanie.devlabs.pl/admin/authenticate-google/return-url',
            'locale' => 'pl',
            ...
            'security.role_hierarchy.roles' => array(
                ...
                'ROLE_PERMISSION_POKWITOWANIE_CREATE' => array(

                ),
                'ROLE_PERMISSION_SALE_CREATE' => array(

                ),
                'ROLE_PERMISSION_USER_SECTION' => array(

                ),
                'ROLE_PERMISSION_CHANGE_REPAIRER' => array(

                ),
                'ROLE_PERMISSION_LOCALIZATION_REPAIRS' => array(

                ),
                'ROLE_PERMISSION_LOCALIZATION_DEVICES' => array(

                ),
                'ROLE_PERMISSION_ALL_REPAIRS' => array(

                ),
                'ROLE_PERMISSION_ALL_DEVICES' => array(
                ...
                'ROLE_SUPER_ADMIN' => array(
                    0 => 'ROLE_ADMIN',
                    1 => 'ROLE_PERMISSION_PUBLIC_MESSAGES',
                    2 => 'ROLE_PERMISSION_POKWITOWANIE_CREATE',
                    3 => 'ROLE_PERMISSION_SALE_CREATE',
                    4 => 'ROLE_PERMISSION_USER_SECTION',
                    5 => 'ROLE_PERMISSION_CHANGE_REPAIRER',
                    6 => 'ROLE_PERMISSION_LOCALIZATION_REPAIRS',
                    7 => 'ROLE_PERMISSION_LOCALIZATION_DEVICES',
                    8 => 'ROLE_PERMISSION_ALL_REPAIRS',
                    9 => 'ROLE_PERMISSION_ALL_DEVICES',
                ),
            ),
            ...
            'twig.form.resources' => array(
                ...
                1 => 'TbbcMoneyBundle:Form:fields.html.twig',
                2 => 'bootstrap_3_layout.html.twig',
                3 => 'MisdPhoneNumberBundle:Form:tel_bootstrap.html.twig',
                4 => 'AppBundle:Form:fields.html.twig',
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'pongosgw@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'G03WaWit',
            ...
            'swiftmailer.mailer.default.single_address' => 'pongosgw@gmail.com',
            'swiftmailer.mailer.default.delivery_addresses' => array(
                0 => 'pongosgw@gmail.com',
            ),
            ...
            'swiftmailer.single_address' => 'pongosgw@gmail.com',
            ...
            'tbbc_money.pair_manager.ratio_file_name' => ($this->targetDirs[2].'/data/tbbc_money/ratio_file_name.csv'),
            ...
            'tbbc_money.currencies' => array(
                0 => 'PLN',
                1 => 'EUR',
            ),
            'tbbc_money.reference_currency' => 'PLN',
            'tbbc_money.decimals' => 2,
            'tbbc_money.enable_pair_history' => false,
            'tbbc_money.ratio_provider' => 'tbbc_money.ratio_provider.yahoo_finance',
            ...
            'vich_uploader.mappings' => array(
                'company_small_logo' => array(
                    'namer' => 'vich_uploader.namer_uniqid',
                    'uri_prefix' => '/uploads/companies/logos',
                    'upload_destination' => ($this->targetDirs[2].'/../web/uploads/companies/logos'),
...
class FOSRestBundleSerializerJMSSerializerAdapter_000000002e990e7e000000007e1fba6aa6a83cf0af948980900b70d37eb17513 extends \FOS\RestBundle\Serializer\JMSSerializerAdapter implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder56f444d35f245646685373 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer56f444d35f251851254257 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties56f444d35f21e974520506 = array(
    ...
    {
        $this->initializer56f444d35f251851254257 && $this->initializer56f444d35f251851254257->__invoke($this->valueHolder56f444d35f245646685373, $this, 'serialize', array('data' => $data, 'format' => $format, 'context' => $context), $this->initializer56f444d35f251851254257);

        return $this->valueHolder56f444d35f245646685373->serialize($data, $format, $context);
    }
    ...
    {
        $this->initializer56f444d35f251851254257 && $this->initializer56f444d35f251851254257->__invoke($this->valueHolder56f444d35f245646685373, $this, 'deserialize', array('data' => $data, 'type' => $type, 'format' => $format, 'context' => $context), $this->initializer56f444d35f251851254257);

        return $this->valueHolder56f444d35f245646685373->deserialize($data, $type, $format, $context);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer56f444d35f251851254257 = $initializer;
    ...
    public function __construct(\JMS\Serializer\SerializerInterface $serializer)
    {
        ...
        if (! $this->valueHolder56f444d35f245646685373) {
            $reflection = $reflection ?: new \ReflectionClass('FOS\\RestBundle\\Serializer\\JMSSerializerAdapter');
            $this->valueHolder56f444d35f245646685373 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\FOS\RestBundle\Serializer\JMSSerializerAdapter $this) {
            unset($this->serializer);
        }, $this, 'FOS\\RestBundle\\Serializer\\JMSSerializerAdapter')->__invoke($this);

        }

        $this->valueHolder56f444d35f245646685373->__construct($serializer);
    }
    ...
    {
        $this->initializer56f444d35f251851254257 && $this->initializer56f444d35f251851254257->__invoke($this->valueHolder56f444d35f245646685373, $this, '__get', array('name' => $name), $this->initializer56f444d35f251851254257);

        if (isset(self::$publicProperties56f444d35f21e974520506[$name])) {
            return $this->valueHolder56f444d35f245646685373->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder56f444d35f245646685373;
    ...
    {
        $this->initializer56f444d35f251851254257 && $this->initializer56f444d35f251851254257->__invoke($this->valueHolder56f444d35f245646685373, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer56f444d35f251851254257);
    ...
    {
        $this->initializer56f444d35f251851254257 && $this->initializer56f444d35f251851254257->__invoke($this->valueHolder56f444d35f245646685373, $this, '__isset', array('name' => $name), $this->initializer56f444d35f251851254257);
    ...
    {
        $this->initializer56f444d35f251851254257 && $this->initializer56f444d35f251851254257->__invoke($this->valueHolder56f444d35f245646685373, $this, '__unset', array('name' => $name), $this->initializer56f444d35f251851254257);
    ...
    {
        $this->initializer56f444d35f251851254257 && $this->initializer56f444d35f251851254257->__invoke($this->valueHolder56f444d35f245646685373, $this, '__clone', array(), $this->initializer56f444d35f251851254257);

        $this->valueHolder56f444d35f245646685373 = clone $this->valueHolder56f444d35f245646685373;
    }

    public function __sleep()
    {
        $this->initializer56f444d35f251851254257 && $this->initializer56f444d35f251851254257->__invoke($this->valueHolder56f444d35f245646685373, $this, '__sleep', array(), $this->initializer56f444d35f251851254257);

        return array('valueHolder56f444d35f245646685373');
    }
    ...
    {
        $this->initializer56f444d35f251851254257 = $initializer;
    }
    ...
    {
        return $this->initializer56f444d35f251851254257;
    }
    ...
    {
        return $this->initializer56f444d35f251851254257 && $this->initializer56f444d35f251851254257->__invoke($this->valueHolder56f444d35f245646685373, $this, 'initializeProxy', array(), $this->initializer56f444d35f251851254257);
    }
    ...
    {
        return null !== $this->valueHolder56f444d35f245646685373;
    }
    ...
    {
        return $this->valueHolder56f444d35f245646685373;
    }
